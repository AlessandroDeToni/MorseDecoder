# MorseDecoder
 ...
 ## NodeMCU setup:
1) Download drivers cp2102 per comunicare con la scheda via USB https://www.silabs.com/developers/usb-to-uart-bridge-vcp-drivers. Per windows 64bit ho scelto CP210x VCP Windows
